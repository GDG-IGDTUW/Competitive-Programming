...
Welcome to the **Competitive Programming Repository**, your all-in-one resource to master core algorithms and problem-solving techniques!
This repository contains **categorized competitive programming topics** with curated questions aimed at helping you learn, practice, and strengthen your skills for coding contests, interviews, and assessments.

---

## 📂 Topics Covered

The repository is organized into folders, each dedicated to a specific CP topic.
Inside each folder, you'll find **high-quality, handpicked questions** designed to enhance your understanding and problem-solving strategies.
...
Push to your forked repo and create a PR.
Your submission will be reviewed, approved, and merged!
